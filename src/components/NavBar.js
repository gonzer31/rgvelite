				...
				<header className="mdl-layout__drawer-header">
					<div className="mdl-layout__header-row">
						<div className="mdl-layout__drawer-button">
							<i className="material-icons forrest-green" onClick={() => hideDrawer()}>close</i>
						</div>
					</div>
				</header>
				<div className="cf">
					<Link to={"/"} onClick={() => hideDrawer()} className="no-underline">
				...
				<footer className="mdl-mini-footer">
					<div className="ph2-ns">
						<div className="dtc pt2 fn-l fl w-auto-l w-100">
							<h2 className="f4 fw3">© 2023 RGV Elite Tennis Academy</h2>
						</div>
